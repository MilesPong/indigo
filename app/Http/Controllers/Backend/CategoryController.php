...
class CategoryController extends Controller
{
    ...
    public function store(StoreUpdateCategoryRequest $request)
    {
        ...
        return redirect()->route('categories.index')->withSuccess('Create category successfully!');
    }
    ...
    public function update(StoreUpdateCategoryRequest $request, $id)
    {
        ...
        return redirect()->route('categories.index')->withSuccess('Update category successfully!');
    }
